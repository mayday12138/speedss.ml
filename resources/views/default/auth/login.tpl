...
<body class="login-page skin-alague">
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form>
            ...
            <div class="form-group has-feedback">
                <input id="passwd" name="Password" type="password" class="form-control" placeholder="密码(8位数)"/>
        ...
        <a href="/password/reset" class="btn btn-primary btn-flat text-center">忘记密码</a>
