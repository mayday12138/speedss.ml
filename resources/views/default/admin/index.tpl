        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-4">
                <div class="small-box bg-yellow">
                    ...
                    <a href="/admin/invite" class="small-box-footer"> 在线用户
                        <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-4">
                <div class="small-box bg-yellow">
                    ...
                    <a href="/admin/checkinlog" class="small-box-footer"> 签到日志
                        <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-4">
                <div class="small-box bg-aqua">
                    ...
                    <a href="/admin/node" class="small-box-footer"> 节点管理
                        <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-4">
                <div class="small-box bg-aqua">
                    ...
                    <a href="/admin/trafficlog" class="small-box-footer"> 流量记录
                        <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
