                    ...
                    <div class="box-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input value="{$userInfo->content}" class="form-control" placeholder="公告内容" id="content">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input value="{$userInfo->hidden}" class="form-control" placeholder="是否隐藏" id="hidden">
                                </div>
                            </div>
                        </div>
                    </div>
