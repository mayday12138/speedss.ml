        ...
        <div class="row">
            <div class="col-md-6">
                <div class="callout callout-warning">
                    ...
                    <p>windows客户端需要先打开节点配置页面 <a href="/user/node/5">hk1节点配置</a> (确保屏幕上有二维码), 然后打开客户端, 右键点击屏幕右下角状态栏的小飞机图标->服务器->扫描屏幕上的二维码(确保小飞机图标->服务器->勾选为最新添加的服务器), 然后右键点击小飞机图标->启动系统代理, 系统代理模式选择全局模式. 配置成功</p>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <p>Windows客户端(xp, win7)&nbsp&nbsp<a href="/downloads/Shadowsocks_win_2.5.6.exe">2.5.6经典版</a>   <a href="/configclient#win">配置教程</a></p>
                        <p>Win10用户可以下载新版&nbsp&nbsp<a href="/downloads/Shadowsocks_win_4.0.1.exe">4.0.1新版</a>   <a href="/configclient#win">配置教程</a></p>
                        <p>Mac客户端&nbsp&nbsp<a href="/downloads/ShadowsocksX-2.6.3.dmg">点击下载</a>   <a href="/configclient#mac">配置教程</a></p>
                        <p>Android客户端&nbsp&nbsp<a href="/downloads/com.github.shadowsocks.apk">点击下载</a>   <a href="/configclient#android">配置教程</a></p>
                        <p>iOS用户请在App Store搜索下载"Wingy"&nbsp&nbsp<a href="https://itunes.apple.com/cn/app/wingy-http-s-socks5-proxy-utility/id1178584911?mt=8" target="_blank">点击查看</a>   <a href="/configclient#ios">配置教程</a></p>
                        <p>Wingy国区已下架, 请下载ipa安装包, 用iTunes安装  <a href="/downloads/wingy.ipa">点击下载</a></p>
                        <p>Linux用户请参考安装手册进行安装   <a href="/configclient#linux">配置教程</a></p>
